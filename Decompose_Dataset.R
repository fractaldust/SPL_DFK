...
#----------------------------------------------------------------------------------
# creates known and unknown data sets for different models
# .f        : full model can be trained (item_retrate and user_ratrate are both clean)
# .i        : model without item_retrate (only user_retrate is clean)
# .u        : model without user_retrate (only item_retrate is clean)
# .iu       : model without item_retrate AND without user_ratrate
#           : BOTH item_retrate and user_retrate contain unreasonable categories
#----------------------------------------------------------------------------------
...
# .f       : full model
#----------------------------------------------------------------------------------
# remove   : "unknown" and "new" of "item_retrate" AND "user_retrate"
# model    : item_retrate AND user_retrate are clean now, can be used for model
# n.k = 25266
# n.u = 10082
...
#----------------------------------------------------------------------------------
# remove   : "unknown" and "new" of "user_retrate"
# model    : user_retrate is clean now, can be used for model
# n.k = 1857
# n.u = 813
...
#----------------------------------------------------------------------------------
# leftover : leftover rows where BOTH "item_retrate" AND "user_retrate" 
#          : have uncertain categories
# model    : user_retrate and item_retrate are both not clean
#          : model without "item_retrate" AND "user_retrate" --> extension .iu
# n.k = 5734
# n.u = 3402
