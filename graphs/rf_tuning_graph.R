...
# g1 <- ggplot(df, aes(x=x, y=tau_c....1.auc)) + geom_point() 
# g2 <- ggplot(df, aes(x=x, y=tau_c....2.auc)) + geom_point() 
# g3 <- ggplot(df, aes(x=x, y=tau_c....3.auc)) + geom_point() 
# g4 <- ggplot(df, aes(x=x, y=tau_c....4.auc)) + geom_point() 
# g5 <- ggplot(df, aes(x=x, y=tau_c....5.auc)) + geom_point() 
# g6 <- ggplot(df, aes(x=x, y=tau_c....6.auc)) + geom_point() 
# 
# plot <- grid.arrange(g1, g2 , g3, g4, g5, g6, nrow = 3, ncol = 2)
# plot
# 
